...
//
//        // Step 1: Read the header row to identify column indices
...
//        }
//
//        // Step 2: Read data rows based on dynamic column indices
...
//    }
//
//    // Helper to read any cell safely as String
...
//
//        // Personalized Main Text with styled student name inline
...
//
//        List<String> beforeLines = wrapText(beforeName, PDType1Font.HELVETICA_BOLD, 20, maxWidth);
//        List<String> afterLines = wrapText(afterName, PDType1Font.HELVETICA_BOLD, 20, maxWidth);
//
...
//        }
//
//        // Draw student name in a different font and size, centered
...
//        currentY -= 30;
//
//        // Draw after name content, centered
